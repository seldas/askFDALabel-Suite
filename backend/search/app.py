...
from prompt_active import prompt_boring

# ✅ Import refactored logic from scripts/search_v1.py
from scripts.search_v1 import (
...
from scripts.search_v2 import search_v2 as search_v2_func


from scripts.search_v2 import (
    AgentState,
    run_controller,
    build_debug_stats,
...
from scripts.search_v2_core.agents.answer_composer import build_answer_messages, run_answer_composer
from scripts.search_v2_core.agents.reasoning_generator import run_reasoning_generator

from scripts.search_v2_core.config import client
try:
    from scripts.search_v2_core.config import llm_model_name  # optional
except Exception:
    llm_model_name = None
...
def chat():
    try:
        ...
        if doc_type == "setids":
            ...
            from file_util import get_xml  # keep local import to reduce global coupling
        ...
        def chat_stream():
            ...
            yield from call_llm_stream_func(chatHistory, spl_xmls, uploaded_files)
