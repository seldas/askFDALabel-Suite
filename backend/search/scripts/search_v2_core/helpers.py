...
def convert_oracle_to_filtered_results(
    ...
    for result in oracle_results:
        ...
        filtered_results[set_id] = {
            ...
            "PRODUCT_NAMES": safe_get(result_dict, "PRODUCT_NAMES", "PRODUCTNAMES", "PRODUCT_TITLE", "DRUG NAME (BRAND - GENERIC)") or "",
            "GENERIC_NAMES": safe_get(result_dict, "PRODUCT_NORMD_GENERIC_NAMES", "GENERIC_NAMES", "PRODUCT_GENERIC_NAMES") or "",
            "COMPANY": safe_get(result_dict, "AUTHOR_ORG_NORMD_NAME", "COMPANY", "MANUFACTURER", "AUTHOR_ORG") or "",
            "APPR_NUM": safe_get(result_dict, "APPR_NUM", "APPROVAL_NUM", "APPLICATION_NUM") or "",
            "ACT_INGR_NAMES": safe_get(result_dict, "ACT_INGR_NAMES", "ACTIVE_INGREDIENTS", "INGREDIENTS") or "",
            "MARKET_CATEGORIES": safe_get(result_dict, "MARKET_CATEGORIES", "MARKETING_CATEGORIES", "APPLICATION_TYPE") or "",
            "DOCUMENT_TYPE": safe_get(result_dict, "DOCUMENT_TYPE", "DOC_TYPE", "LABEL_TYPE") or "",
            "Routes": safe_get(result_dict, "ROUTES_OF_ADMINISTRATION", "ROUTES", "ROUTE") or "",
            "DOSAGE_FORMS": safe_get(result_dict, "DOSAGE_FORMS", "DOSAGEFORMS", "FORMULATION") or "",
            "EPC": safe_get(result_dict, "EPC", "PHARMACOLOGIC_CLASS", "PHARM_CLASS") or "",
            "NDC_CODES": safe_get(result_dict, "NDC_CODES", "NDC", "PRODUCT_NDC") or "",
            "SPL_ID": safe_get(result_dict, "SPL_ID", "SPLID") or "",
            "REVISED_DATE": safe_get(result_dict, "REVISED_DATE", "REVISION_DATE") or "",
            "INITIAL_APPROVAL_YEAR": safe_get(result_dict, "INITIAL_APPROVAL_YEAR", "APPROVAL_YEAR") or "",
            "SPL_LINK": result_dict.get("SPL_LINK") or "",
            "SECTION_TITLE": safe_get(result_dict, "SECTION_TITLE", "TITLE") or "",
            "RLD": result_dict.get("RLD") or "No",
        }
