...
from scd_scdc
join scd on scd_scdc.scd_rxcui = scd.rxcui
join scdc on scd_scdc.scdc_rxcui = scdc.rxcui
...
join scd_scdc on scd_scdc.scd_rxcui = scdg_scd.scd_rxcui
join scdc on scdc.rxcui = scd_scdc.scdc_rxcui
...
select distinct scd_scdc.scdc_rxcui, sbdc.rxcui
from sbdc
join sbd on sbd.sbdc_rxcui = sbdc.rxcui
join scd_scdc on scd_scdc.scd_rxcui = sbd.scd_rxcui
;
