document.addEventListener('DOMContentLoaded', function () {
    ...
    async function loadMeddraScan(setId) {
        try {
            const response = await fetch(`/api/meddra/scan_label/${setId}`);
