  ...
  const features = [
    {
      ...
      description: "We leverage large language models to move beyond keyword search, enabling researchers to ask complex clinical and pharmacological questions directly of the FDA label corpus.",
      image: "https://images.unsplash.com/photo-1677442136019-21780ecad995?auto=format&fit=crop&q=80&w=1200"
    },
    {
      title: "Safety Surveillance",
      description: "By integrating FAERS data trends with label comparison tools, we provide a unified dashboard for signal detection and regulatory history analysis.",
    ...
    },
    {
      ...
      description: "Transforming raw Structured Product Labeling (SPL) into actionable knowledge through automated extraction, indexing, and multi-dimensional analysis.",
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#f9fafb' }}>
      ...
      <header className="header-main" style={{ justifyContent: 'space-between', padding: '0.5rem 2rem' }}>
        ...
        <nav style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          {isInternal ? (
            <div className="hp-nav-dropdown">
              ...
              <div className="hp-dropdown-content" style={{ marginTop: '0' }}>
        ...
        {/* Right: User Controls */}
        <nav style={{ display: 'flex', alignItems: 'center', gap: '16px', flex: '0 0 250px', justifyContent: 'flex-end' }}>
          {loading ? (
      ...
      {/* Immersive Mission Section (Now at Top) */}
      <section className="mission-section" style={{ padding: '4rem 2rem 2rem 2rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{ position: 'relative', display: 'inline-block' }}>
            <h1 className="suite-home-title-animated" style={{ fontSize: '4rem', fontWeight: 900, marginBottom: '1rem' }}>
              AskFDALabel
            </h1>  
...
function MiniScientificCard({ title, href, icon, children }: { title: string, href?: string, icon: React.ReactNode, children?: React.ReactNode }) {
  const content = (
