...
export default function DrugToxPage() {
  ...
  return (
    ...
    >
      ...
      {/* Unified Header & Menu */}
      <header className="header-main" style={{ width: '100vw', position: 'sticky', top: 0, zIndex: 1000, justifyContent: 'space-between', padding: '0.5rem 2rem' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flex: '0 0 250px', justifyContent: 'flex-end' }}>
          {userLoading ? (
            ...
            <a href="/api/dashboard/auth/login?next=/drugtox" style={{ color: 'white', fontSize: '0.875rem', textDecoration: 'none', background: 'rgba(255,255,255,0.1)', padding: '6px 16px', borderRadius: '20px' }}>Sign In</a>
          )}
        </div>
      </header>
